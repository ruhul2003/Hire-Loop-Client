  ...
  return (
    <section className="relative w-full min-h-screen bg-black text-white pt-20 pb-32 px-4 overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="relative max-w-4xl mx-auto w-full z-10 flex flex-col items-center text-center">
        ...
        {/* Top Glow Badge */}
        <div className="inline-flex items-center gap-2 bg-[#121214] border border-zinc-800/60 rounded-full px-4 py-1.5 mb-8 shadow-[0_0_15px_rgba(99,102,241,0.05)]">
        ...
        {/* Main Heading */}
        <h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-white mb-6 max-w-3xl leading-[1.15]">
          Find Your Dream Job Today
        </h1>

        {/* Subtitle Description */}
        <p className="text-zinc-400 text-base sm:text-lg font-light max-w-2xl leading-relaxed mb-12">
        ...
        <div className="w-full max-w-3xl bg-[#0c0c0e]/80 backdrop-blur-md border border-zinc-800/80 rounded-2xl p-2 flex flex-col sm:flex-row items-center gap-2 shadow-2xl">
          ...
          {/* Search Button */}
          <button className="bg-[#4f46e5] hover:bg-[#4338ca] text-white p-3 sm:p-3.5 rounded-xl transition-colors shrink-0 w-full sm:w-auto flex items-center justify-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mt-8 text-sm">
          ...
          <button className="bg-zinc-900/40 border border-zinc-800/80 hover:border-zinc-700 text-zinc-300 px-4 py-1.5 rounded-full text-xs font-medium transition-colors">
            Product Designer
          </button>
      ...
      {/* Bottom Ambient Dot Lights (Optional - matching the screen stars) */}
